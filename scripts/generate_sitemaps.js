...
const staticRoutes = [
  ...
  { url: 'https://confluxai.in/refund-policy', changefreq: 'monthly', priority: '0.7' },
  { url: 'https://confluxai.in/privacy-policy', changefreq: 'monthly', priority: '0.7' },
  { url: 'https://confluxai.in/terms', changefreq: 'monthly', priority: '0.7' },
