// Conflux Platform — Contact & Consultation Intake Page
    ...
    <div className="min-h-screen bg-white text-slate-900 pt-28 pb-20 px-4 sm:px-6 lg:px-8 font-inter">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl font-black font-orbitron tracking-tight text-slate-950">
            Connect With <span className="text-blue-600">Conflux AI</span>
          </h1>
          <p className="text-slate-600 text-base sm:text-lg max-w-2xl mx-auto font-normal leading-relaxed">
            Discuss your local business visibility, Schema.org entity architecture, statutory evidence verification, or speed-to-lead mobile conversion funnels.
          </p>
        </motion.div>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="p-8 rounded-3xl bg-slate-50 border border-slate-200 shadow-md space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="https://wa.me/919734433100" target="_blank" rel="noopener noreferrer" className="text-slate-900 font-bold text-sm hover:text-emerald-600 transition-colors">
                    +91 97344 33100
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="text-[11px] text-slate-500 font-bold uppercase tracking-wider">Operational Office</div>
            ...
            <div className="p-8 rounded-3xl bg-slate-50 border border-slate-200 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xs font-bold text-slate-900 uppercase tracking-wider">Response Commitment</h3>
              </div>
              <p className="text-slate-600 text-xs leading-relaxed font-normal">
                All inquiries are received directly by our technical team. You will receive an initial response and tailored visibility assessment within 24 hours.
              </p>

              <div className="pt-2 flex items-center gap-3 border-t border-slate-200/80">
                <ShieldCheck className="w-5 h-5 text-emerald-600" />
                <span className="text-xs text-slate-700 font-medium">100% Confidential &bull; Zero Spam</span>
              </div>
            </div>
          </div>
