...
export const BusinessValueModal: React.FC<BusinessValueModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-3 sm:p-6 bg-slate-900/60 backdrop-blur-sm overflow-y-auto font-inter">
      <div className="bg-white w-full max-w-3xl max-h-[min(90vh,820px)] flex flex-col rounded-2xl sm:rounded-3xl border border-slate-200 shadow-2xl overflow-hidden my-auto">
        
        {/* Header Bar */}
        <div className="bg-slate-950 text-white p-5 sm:p-8 flex items-start justify-between gap-4 border-b border-slate-800 shrink-0">
        ...
        {/* Content Body */}
        <div className="p-5 sm:p-8 space-y-8 overflow-y-auto flex-1 overscroll-contain">
